<div class="max-w-xl mx-auto bg-white border border-[#feeae0] rounded-3xl p-8 shadow-md space-y-6">
    ...
    <div class="border-b border-[#feeae0] pb-4">
        <h1 class="text-3xl font-extrabold text-[#231914] font-display-lg">Profile Editor</h1>
        <p class="text-sm text-[#897266]">Keep your account details up to date.</p>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <!-- Name Input -->
        <div class="space-y-2">
            <label for="name" class="block text-sm font-bold text-[#231914] font-headline-md">Name</label>
            <input 
                type="text" 
                wire:model="name" 
                id="name"
        ...
        <!-- Phone Input -->
        <div class="space-y-2">
            <label for="phone" class="block text-sm font-bold text-[#231914] font-headline-md">Phone Number</label>
            <input 
                type="text" 
                wire:model="phone" 
                id="phone"
        ...
        @if (auth()->user()->role === 'penjual')
            <div class="space-y-2">
                <label for="store_name" class="block text-sm font-bold text-[#231914] font-headline-md">Store Name</label>
                <input 
                    type="text" 
